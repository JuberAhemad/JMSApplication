<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="home">ZMQ Technologies</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="navbar-nav ">
			...
			<li class="nav-item"><a class="nav-link" href="loginForm"> <i
					class="fa fa-sign-in" aria-hidden="true"></i> LogIn

			</a></li> 
			
			<li class="nav-item"><a class="nav-link" href="addUserform"> <i
